...
<div id="returner">
	...
	<label>Password:</label> <input type="text" id="password" name="password" value="" required/><br><br>
...
<div id="new">
	...
	<label>Email:</label> <input type="text" id="email" name="email" value="" required/><br>
	<label>Password:</label> <input type="text" id="password" name="password" value="" required/><br>
